...
type OptimisticLike = { like_count: number; is_liked: boolean }

type LikeButtonProps = {
  recipe: Pick<Recipe, "id" | "like_count" | "is_liked">
  isAuthenticated: boolean
  isOwnRecipe: boolean
  onRecipeChange?: (
    patch: Pick<Recipe, "id" | "like_count" | "is_liked">,
  ) => void
...
export default function LikeButton({
  ...
  const [optimistic, setOptimistic] = useState<OptimisticLike | null>(null)
