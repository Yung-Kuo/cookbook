...
export default function CheckboxLabel({
  ...
  return (
    <label
      className={`flex cursor-pointer items-center gap-4 rounded focus-within:outline-none hover:bg-neutral-800 has-[:disabled]:cursor-not-allowed ${labelClassName ?? ""}`.trim()}
    >
      <input
        type="checkbox"
        checked={checked}
