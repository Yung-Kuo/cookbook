...
class RecipeViewSet(ModelViewSet):
    ...
    def _recipe_write_forbidden_response(self, recipe):
    ...
    def update(self, request, *args, **kwargs):
        ...
        forbidden = self._recipe_write_forbidden_response(instance)
        if forbidden:
            return forbidden
    ...
    def upload_image(self, request, pk=None):
        ...
        recipe = self.get_object()
        forbidden = self._recipe_write_forbidden_response(recipe)
        if forbidden:
            return forbidden
