...
class RecipeViewSet(ModelViewSet):
    ...
    def _owner_required_response(self, recipe, action):
        if not self.request.user.is_authenticated or recipe.owner_id != self.request.user.pk:
            return Response(
    ...
    def create(self, request, *args, **kwargs):
        ...
        recipe = self._detail_queryset().get(pk=serializer.instance.pk)
    ...
    def update(self, request, *args, **kwargs):
        ...
        owner_error = self._owner_required_response(instance, "edit")
    ...
    def destroy(self, request, *args, **kwargs):
        instance = self.get_object()
        owner_error = self._owner_required_response(instance, "delete")
        if owner_error is not None:
            return owner_error
    ...
    def upload_image(self, request, pk=None):
        ...
        recipe = self.get_object()
        owner_error = self._owner_required_response(recipe, "edit")
        if owner_error is not None:
            return owner_error
