...
class RecipeViewSet(ModelViewSet):
    ...
    def _forbid_unless_owner(self, recipe, message):
        if (
    ...
    def update(self, request, *args, **kwargs):
        ...
        denied = self._forbid_unless_owner(
            instance, "You do not have permission to edit this recipe."
        )
    ...
    def destroy(self, request, *args, **kwargs):
        instance = self.get_object()
        denied = self._forbid_unless_owner(
            instance, "You do not have permission to delete this recipe."
        )
        if denied is not None:
            return denied
    ...
    def upload_image(self, request, pk=None):
        ...
        recipe = self.get_object()
        denied = self._forbid_unless_owner(
            recipe, "You do not have permission to edit this recipe."
        )
        if denied is not None:
            return denied
